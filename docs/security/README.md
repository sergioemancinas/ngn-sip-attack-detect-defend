...
flowchart TB
    ...
    subgraph L6["6 · Supply chain / CI"]
      CI["Aikido (SAST/SCA/IaC) · Trivy · Docker Scout · Gitleaks<br/>Dependabot · release SBOM · OpenSSF Scorecard"]
    end
...
| [`container_security_automation.md`](container_security_automation.md) | The CI/local vulnerability-gate stack (Aikido, Trivy, Docker Scout, Gitleaks) and its boundary with Wazuh/Shuffle |
