...
| Key rotation | Manual via Keycloak admin | Document: rotate before each MS deliverable; verify clients re-fetch JWKS after rotation |
...
- [ ] Delete the `examiner-readonly` placeholder once the meeting is over.
