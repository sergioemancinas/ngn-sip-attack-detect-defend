...
The ClickHouse datasource backs the analytics dashboards (SIP events, Suricata/Wazuh alerts, ML and LLM verdicts). The Prometheus datasource backs the Kamailio, Asterisk, rtpengine, and service-health metrics. The dashboards themselves (D1-D7) are listed in the top-level [README](../../README.md).
